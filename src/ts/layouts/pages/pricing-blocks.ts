...
export class PricingBlocks {
    ...
    configureExpandableBlocks(): void {
        ...
        var blockExpanderButtons: NodeListOf<HTMLElement> = document.querySelectorAll(
            ".pricing-block .block-expander"
        );
    ...
    configureExpandableRows(): void {
        ...
        var expandableRows: NodeListOf<HTMLElement> = document.querySelectorAll(
            ".pricing-block__body-row-header--expandable"
        );
        ...
        expandableRows.forEach((element) => {
            ...
            var targetContent: HTMLElement = element.parentElement.querySelector(
                ".pricing-block__body-row-body"
            );
